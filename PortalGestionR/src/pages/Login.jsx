...
const Login = () => {
    ...
    return (
        // 1. TRUCO INFALIBLE: 'fixed inset-0' fuerza a que ocupe TODA la pantalla.
        // 2. DISEÑO: Un degradado oscuro muy elegante (azul marino y pizarra) para que el Login destaque.
        <div className="fixed inset-0 w-full flex items-center justify-center bg-gradient-to-br from-slate-900 via-corporate-dark to-slate-800 p-4">
            ...
            <div className="w-full max-w-md bg-white rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] p-8 sm:p-10 transform transition-all">
                ...
                <div className="text-center mb-8">
                    ...
                    <div className="mx-auto w-16 h-16 bg-corporate text-white rounded-2xl flex items-center justify-center text-3xl mb-5 shadow-lg rotate-3">
                        🏢
                    </div>
